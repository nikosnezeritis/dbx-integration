from test_project.workloads.sample_etl_job import SampleETLJob
from test_project.workloads.sample_ml_job import SampleMLJob
...
def test_jobs(spark: SparkSession, tmp_path: Path):
    ...
    test_ml_config = {
        "input": common_config,
        "experiment": "/Shared/test_project/sample_experiment"
    }
